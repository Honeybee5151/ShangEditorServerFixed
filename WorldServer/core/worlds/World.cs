...
namespace WorldServer.core.worlds
{
    public class World
    {
        ...
        //editor8182381 — Custom ground/object entries and pre-compressed message chunks
        ...
        //editor8182381 — Load map with custom ground/object registration and pre-compression
        public bool LoadMapFromData(WorldResource worldResource)
        {
            ...
            //editor8182381 — Register custom object ObjectDescs BEFORE loading map
            ...
            //editor8182381 — Store custom ground entries for this dungeon (sent as binary to client)
            if (gameData.JmCustomGrounds.TryGetValue(jmPath, out var customGrounds))
                CustomGroundEntries = customGrounds;

            //editor8182381 — Pre-compress custom message chunks once at load
            PreCompressCustomChunks();

            return true;
        }

        //editor8182381 — Pre-compress custom ground/object entries into 500-entry chunks
        ...
        //editor8182381 — Compress a chunk of custom ground entries into binary blob
        ...
        //editor8182381 — Compress a chunk of custom object entries into binary blob
        ...
        {
            //editor8182381 — Unregister custom objects from shared dictionaries to prevent memory leak
            if (CustomObjectEntries != null && CustomObjectEntries.Count > 0)
            {
            ...
            Map.Clear();
            //editor8182381 — Clear custom ground/object caches
